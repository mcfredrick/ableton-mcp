...
1. Set up mastering chain — check what's already on the master track (track_index=-1), load any missing devices (EQ Eight → Multiband Dynamics → Glue Compressor → Limiter → AbletonMCP Analyzer) in signal-chain order
